---
title: "Professions"
description: "Character professions and their skills, equipment, and backgrounds for SagaBorn D100"
order: 4
---
...
> **Contacts** - A contact is a player created NPC in the world who they know and can use for help or information. This contact is created at anytime and is made in agreement with both the player and the SG.
...
- **Skills:** Bargain, Craft (any), Knowledge (Natural History), Listen, Spot, and five of the following: Brawl, Drive, First Aid, Knowledge (History), Repair (Mechanical), Ranged Weapon (Bow), Ride, Track.
- **Recommended Archetype Talent Paths:** Fighter
...
- **Starting:** Basic clothing, a small weapon, and 1 contact. Funds: 12d4 gp at character creation.
