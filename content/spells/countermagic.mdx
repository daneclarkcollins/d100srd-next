...
You may cast _Countermagic_ as a reaction to interrupt another caster’s spell. State your intention to cast _Countermagic_ and the amount of mana you’ll use before learning the opponent’s spell mana cost. Both casters roll a Heroic Action using their Spellcraft skill, with the higher successful roll prevailing. Countermagic disrupts the magical energy of the targets spell according to the mana spent on Countermagic. If the mana spent on counter magic meets or exceeds the amount spent on the original casting, then the targeted spell is canceled. If it is less, this will lower the power of the targeted spell equal to the Countermagic spent mana.
